...
public class a1_c2_Events : MonoBehaviour, IInterfaceEvent
{
    ...
    private void Start()
    {
        ...
        if (AreaManager.instance.checkpointRespawnCount == 1)
        {
            ...
            tabulator.GetComponent<tabulator>().SetDialogueCSV("a1_c2_respawn");
        ...
        {
            gate.GetComponent<IInterfaceEvent>().InterfaceEvent("Activate");
            tabulator.GetComponent<tabulator>().SetDialogueCSV("a1_c2_1");
            tabEnableObj.SetActive(false);
    ...
    {
        DialogueManager.instance.onDialogueEnded -= SetFinalDialogue;
        tabulator.GetComponent<tabulator>().SetDialogueCSV("a1_c2_2");
        tabInteractObj.SetActive(true);
    }
    ...
    private IEnumerator EnableTabulatorSequence()
    {
        ...
        DialogueManager.instance.BeginDialogue("a1_c2_1");
